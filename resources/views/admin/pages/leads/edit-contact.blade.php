                ...
                <div class="form-container">
                    <form action="{{ route('admin.lead.update',['id' => $leads->id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" class="form-input" name="name" value="{{ $leads->name }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="email">Email <span class="wpforms-required-label">*</span></label>
                            <input type="email" id="email" class="form-input" name="email" value="{{ $leads->email }}" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="phone">Phone</label>
                            <input type="tel" id="phone" class="form-input" name="phone" value="{{ $leads->phone }}">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="role">Tell Us About Yourself</label>
                            <select id="role" class="form-select" name="role" value="{{ $leads->role }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" class="form-textarea" name="message" id="" cols="30" rows="10">{{ $leads->message }}</textarea>
                        </div>
